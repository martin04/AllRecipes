...
public class DinnerActivity extends AppCompatActivity {
    ...
    private RecyclerView dinner;
    private RecipeAdapter adapter;
    private LinearLayoutManager manager;
    private List<RecipeInfo> data;
    private String url = "http://rss.allrecipes.com/daily.aspx?hubID=80";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dinner = (RecyclerView) findViewById(R.id.lstDinner);
        manager = new LinearLayoutManager(this);
        dinner.setLayoutManager(manager);
        ...
        if (!isConnected) {
            ...
            new DownloadXML(new Callback() {
                ...
                public void onResult(List<RecipeInfo> result) {
                    Toast.makeText(ctx, "dinner loaded", Toast.LENGTH_SHORT).show();
    ...
    private void connectionDialog() {
        new AlertDialog.Builder(DinnerActivity.this)
                ...
                .setNegativeButton(R.string.connection_cancel_dialog, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        NavUtils.navigateUpFromSameTask(DinnerActivity.this);
                    }
                })
