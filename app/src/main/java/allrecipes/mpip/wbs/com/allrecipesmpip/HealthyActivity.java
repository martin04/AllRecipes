...
public class HealthyActivity extends AppCompatActivity {
    ...
    private RecyclerView healthy;
    private RecipeAdapter adapter;
    private LinearLayoutManager manager;
    private List<RecipeInfo> data;
    private String url = "http://rss.allrecipes.com/daily.aspx?hubID=84";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.healthy_activity);

        assert getSupportActionBar() != null;
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        healthy = (RecyclerView) findViewById(R.id.lstHealthy);
        manager = new LinearLayoutManager(this);
        healthy.setLayoutManager(manager);
        ...
        if(!isConnected){
            ...
            new DownloadXML(new Callback() {
                ...
                public void onResult(List<RecipeInfo> result) {
                    Toast.makeText(ctx, "healthy loaded", Toast.LENGTH_SHORT).show();
                    adapter = new RecipeAdapter(result);
                    healthy.setAdapter(adapter);
                }
    ...
    private void connectionDialog(){
        new AlertDialog.Builder(HealthyActivity.this)
                ...
                .setNegativeButton(R.string.connection_cancel_dialog, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        NavUtils.navigateUpFromSameTask(HealthyActivity.this);
                    }
                })
